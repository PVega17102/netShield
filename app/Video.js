...
const Video = ({ route, navigation }) => {
    ...
    // Define a boolean variable to check if the user has completed 5 tries
    const maxTries = 5;
    const hasValidTries = quizAttempts < maxTries;
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View>
                    ...
                    <Text style={styles.quiz_attempts}>Intentos: {quizAttempts}/{maxTries}</Text>
                </View>
...

            {
                quizCompleted ? (
                    ...
                    <Text style={styles.course_completed_message}>Has completado esta seccion satisfactoriamente.</Text>
                    </View>
                    <Button
                        mode='contained'
                        theme={{roundness: 1}}
                ...
                hasValidTries ? (
                    ...
                    <View style={styles.displaycontainer}>
                        <Text style={styles.note_no_attempts}>Has agotado tus intentos para el quiz de esta seccion</Text>
                    </View>
                )
            }
            </View>
